...
def camera1_callback(img_msg):
    global value, c0, c1, c2, c3, c4, c5, c6, c7, c8 , c9, c10, c11, c12, c13, c14, c15
    try:
    ...
    if movex == 0.0 and movey == 0.0 and movez == 0.0:
        img = cv2.resize(cv_image,(1000,560))
...
def camera3_callback(img_msg):
    ...
    if movex == 0.0 and movey == 0.0 and movez == 0.0:
        ...
        print("Shelf 1: " + str(sum(c1)))
        print("Shelf 2: " + str(sum(c9)))
        print("Shelf 3: " + str(sum(c2)))
        print("Shelf 4: " + str(sum(c10)))
        print("Shelf 5: " + str(sum(c3)))
        print("Shelf 6: " + str(sum(c11)))
        print("Shelf 7: " + str(sum(c4)))
        print("Shelf 8: " + str(sum(c12)))
        print("Shelf 9: " + str(sum(c5)))
        print("Shelf 10: " + str(sum(c13)))
        print("Shelf 11: " + str(sum(c6)))
        print("Shelf 12: " + str(sum(c14)))
        print("Shelf 13: " + str(sum(c7)))
        print("Shelf 14: " + str(sum(c15)))
        print("Shelf 15: " + str(sum(c0)))
        print("Shelf 16: " + str(sum(c8)))
    else:
        cv2.destroyAllWindows()
        #print("Robot is Moving")
